...
models = [
    ...
    Model(
        name="GPT 5 Responses Azure",
        type="OpenAI",
        id="8caddb25-bd38-46cf-8ad7-c6f55879c26e",
        client="OpenAI - Responses - Azure",
        capabilities=Capabilities(
            standard_text_test=True,
            prompt_with_image_urls=True,
            basic_param_values=True,
    ...
    Model(
        name="Claude Sonnet 4.5 Anthropic Vertex",
        type="Anthropic",
        id="aa876e7e-e78e-404d-b7db-1a44236bc2a5",
        client="Anthropic - Vertex",
        capabilities=Capabilities(
            standard_text_test=True,
            prompt_with_image_urls=True,
    ...
    Model(
        ...
        type="Google GenAI",
        id="92a36505-f4af-4bfa-8608-edeb401f341d",
    ...
    Model(
        name="Gemini Pro 2.5 Vertex",
        type="Google GenAI",
        id="d8dabe32-2207-47f5-a310-c364151ba969",
        client="Google GenAI - Vertex",
        capabilities=Capabilities(
            standard_text_test=True,
            prompt_with_image_urls=True,
    ...
    Model(
        name="Gemini 3 Pro",
        type="Google GenAI",
        id="7c07f43c-dfd3-4570-9617-26e0e39a1998",
    ...
    Model(
        ...
        capabilities=Capabilities(
            ...
            prompt_with_image_urls=True,
            basic_param_values=True,
            tool_calling_with_tool_choice=False,
            structured_json_test=False,
        ),
    ),
    Model(
        name="Llama3 70B",
